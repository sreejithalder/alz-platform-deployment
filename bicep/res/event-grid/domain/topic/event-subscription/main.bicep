...
@description('Required. The name of the Event domain Namespace Subscription.')
param domainNamespaceName string
...
resource domainNamespace 'Microsoft.EventGrid/domains@2025-02-15' existing = {  
  name: domainNamespaceName
}


resource topic 'Microsoft.EventGrid/domains/topics@2025-02-15' existing = {
  parent: domainNamespace
  name: topicName
}
...
//   }
// }
resource eventSubscription 'Microsoft.EventGrid/domains/topics/eventSubscriptions@2022-06-15' = {
  parent: topic
  name: name  
  properties: {
    deadLetterDestination: !empty(deadLetterDestination) ? deadLetterDestination : null
