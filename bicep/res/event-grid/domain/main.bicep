...
@description('Required. The name of the Event Grid Domain. eventDeliverySchema ')
param eventDeliverySchema string
...
@description('Optional. Location for all Resources.')
param autoCreateTopicWithFirstSubscription bool = false

@description('Optional. Location for all Resources.')
param autoDeleteTopicWithLastSubscription bool = false
...
resource domain 'Microsoft.EventGrid/domains@2025-02-15' = {
  ...
  properties: {
    ...
    inputSchema : eventDeliverySchema
  }
}
